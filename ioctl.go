...
// TODO: Using a limited interface like this over direct access of ioctl
//       is more secure because it limits the available surface to the
//       functions interacting with the ioctl systecall
...
func ioctlreq(fd int, req uint, data uintptr) error {
